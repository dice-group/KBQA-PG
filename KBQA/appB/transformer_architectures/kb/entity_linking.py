...
from allennlp.data import DatasetReader, Vocabulary, Tokenizer
...
from KBQA.appB.transformer_architectures.kb.common import get_dtype_for_module, F1Metric
...
class EntityLinkingBase(Model):
    ...
    def _compute_f1(self,
        ...
        for gi, gs, g_batch_index in zip(valid_gold_entity_id, valid_gold_entity_spans, batch_indices.tolist()):
