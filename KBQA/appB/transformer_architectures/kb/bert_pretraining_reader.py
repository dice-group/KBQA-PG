...
from KBQA.appB.transformer_architectures.kb.bert_tokenizer_and_candidate_generator import sep_token
from KBQA.appB.transformer_architectures.kb.bert_tokenizer_and_candidate_generator import start_token
