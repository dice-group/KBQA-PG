...
from KBQA.appB.transformer_architectures.kb.entity_linking import BaseEntityDisambiguator, EntityLinkingBase
...
class EntityDisambiguator(BaseEntityDisambiguator, torch.nn.Module):
    def __init__(self,
        ...
        self.projected_span_layer_norm = torch.nn.LayerNorm(entity_embedding_dim, eps=1e-5)
...
class SolderedKG(Model):
    def __init__(self,
        ...
        self.weighted_entity_layer_norm = torch.nn.LayerNorm(self.entity_embedding_dim, eps=1e-5)
        ...
        # for the output!
        self.output_layer_norm = torch.nn.LayerNorm(self.contextual_embedding_dim, eps=1e-5)
    ...
    def forward(self,
        ...
        spans_with_entities = self.weighted_entity_layer_norm(
            (span_representations + self.dropout(weighted_entity_embeddings)).contiguous()
        )
