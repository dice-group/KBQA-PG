...
- dbo:Company;;;Who is the founder of <A>?;SELECT DISTINCT ?uri where { <A> dbo:foundedBy ?uri};generator query;id
- dbo:Company;;;Who founded <A>?;SELECT DISTINCT ?uri where { <A> dbo:foundedBy ?uri};generator query;id
- dbo:Company;;;When was <A> founded?;SELECT DISTINCT ?uri where {<A> dbo:foundingYear ?uri};generator query;id
- dbo:Company;;;In which city is <A>'s headquarters?;SELECT DISTINCT ?uri where {<A> dbo:headquarter ?headquarter. ?headquarter dbp:location ?uri};generator query;id
- dbo:Company;;;In which industry is <A>?;SELECT DISTINCT ?uri where {<A> dbo:industry ?uri};generator query;id
- dbo:Company;dbo:Company;;Is <A> a subsidiary of <B>?;ASK where { <A> dbo:parentCompany <B>};generator query;id
- dbo:Company;;;List all products from <A>.;SELECT DISTINCT ?uri where { <A> dbo:products ?uri};generator query;id
- dbo:Company;;;What is <A>'s annual revenue?;SELECT DISTINCT ?uri where { <A> dbo:revenue ?uri};generator query;id

# http://dbpedia.org/ontology/Activity

- dbo:Activity;;;What ball is used in <A>?;SELECT DISTINCT ?uri where { <A> dbp:ball ?uri};generator query;id
- dbo:Activity;;;How large is the team size in <A>?;SELECT DISTINCT ?uri where {<A> dbo:teamSize ?uri};generator query;id
- dbo:Activity;;;How long is the playing time of <A>?;SELECT DISTINCT ?uri where {<A> dbp:playingTime ?uri};generator query;id
...
- dbr:Actor;;;When did <A> start acting?;SELECT DISTINCT ?uri where {<A> dbo:activeYearsStartYear ?uri};generator query;id
- dbr:Actor;;;What movies did <A> star in?;SELECT DISTINCT ?uri where {?uri dbo:starring <A>};generator query;id
- dbr:Actor;dbo:Film;;Did <A> star in <B>?;ASK where {<B> dbo:starring <A>};generator query;id
- dbr:Actor;;;What is the production Company of <A>?;SELECT DISTINCT ?uri where {?uri dbo:productionCompany dbr:Tom_Cruise}

# http://dbpedia.org/ontology/Film

- dbo:Film;;;Who are producers of <A>?;SELECT DISTINCT ?uri where {<A> dbo:producer ?uri};generator query;id
- dbo:Film;;;How much was the budget of <A>?;SELECT DISTINCT ?uri where {<A> dbo:budget ?uri};generator query;id
- dbo:Film;;;Who is the director of <A>?;SELECT DISTINCT ?uri where {dbr:Mission:_Impossible_III dbo:director ?uri};generator - query;id
- dbo:Film;;;Who are the stars in <A>?;SELECT DISTINCT ?uri where {<A> dbo:starring ?uri};generator query;id
- dbo:Film;;;How long is <A>?;SELECT DISTINCT ?uri where {<A> dbo:runtime ?uri};generator query;id
- dbo:Film;;;When was <A> released?;SELECT DISTINCT ?uri where {<A> dbp:released ?uri};generator query;id


# http://dbpedia.org/ontology/Place

- dbo:Place;;;Where is <A>?;SELECT DISTINCT ?uri where {<A> dbo:country ?uri};generator query;id
- dbo:Place;;;Where is <A>?;SELECT DISTINCT ?uri where {<A> dbp:country ?uri};generator query;id
- dbo:Place;;;How many people live in <A>?;SELECT DISTINCT ?uri where {<A> dbp:populationTotal ?uri};generator query;id
- dbo:Place;;;What is the population of <A>?;SELECT DISTINCT ?uri where {<A> dbp:populationTotal ?uri};generator query;id
- dbo:Place;;;When was <A> established;SELECT DISTINCT ?uri where {<A> dbp:establishedDate ?uri};generator query;id

# http://dbpedia.org/ontology/Publisher
# http://dbpedia.org/ontology/Genre
# http://dbpedia.org/ontology/Language

- dbo:Language;;;In which region do people speak <A>?;SELECT DISTINCT ?uri where {<A> dbp:region ?uri};generator query;id
- dbo:Language;;;Which language family does <A> belong to?;SELECT DISTINCT ?uri where {<A> dbo:languageFamily ?uri};generator query;id


# http://dbpedia.org/ontology/Department
# http://dbpedia.org/ontology/Software

- dbo:Software;;;Who developed <A>?;SELECT DISTINCT ?uri where {<A> dbp:developer ?uri};generator query;id
- dbo:Software;;;Who developed <A>?;SELECT DISTINCT ?uri where {<A> dbo:releaseDate ?uri};generator query;id
- dbo:Software;;;What operating system can <A> run on?;SELECT DISTINCT ?uri where {<A> dbo:operatingSystem ?uri};generator query;id
- dbo:Software;;;Who is the designer of <A>?;SELECT DISTINCT ?uri where {<A> dbp:designer ?uri};generator query;id
...
# http://dbpedia.org/ontology/انتظامی_علاقہ
...
# http://dbpedia.org/ontology/کھیلوں_کی_انجمن
