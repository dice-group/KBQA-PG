...
def query_dbpedia(query):
    ...
    try:
        ...
        j = resp.read()
        resp.close()
    # except (urllib.error.HTTPError, http.client.BadStatusLine,urllib.error.URLError): #modified by Tejas
    except (urllib.error.HTTPError, urllib.error.URLError):  # modified by Tejas
