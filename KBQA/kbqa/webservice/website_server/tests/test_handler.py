"""Test module to test the functionality of the handler."""
import json
import unittest
...
class TestHandler(unittest.TestCase):
    """Unittest class to test the functionality of the handler.

    Test the extraction of bindings from a QALD-string and the
    formating of these extractions.
    """
    ...
    def test_qald_parsing_for_single_answer(self) -> None:
        """Test the functionality if there is one answer."""
    ...
    def test_qald_parsing_for_multiple_answers(self) -> None:
        """Test the functionality if there are multiple answers."""
    ...
    def test_qald_parsing_for_empty_answer(self) -> None:
        """Test the functionality if no answer is found."""
